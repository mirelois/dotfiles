...
local calendar_bar = wibox({
    ...
    x        = screen.primary.geometry.x + (screen.primary.geometry.width - beautiful.calendar_width - beautiful.bar_horizontal_gap),
    -- y        = beautiful.bar_height + 2 * beautiful.bar_top_gap,
    y        = screen.primary.geometry.y + (beautiful.bar_height + 2 * beautiful.bar_top_gap),
    bg       = beautiful.bar_bg,
